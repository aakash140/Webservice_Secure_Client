 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://secure.ws.java.com/", wsdlLocation = "http://localhost:8085/ws_secure/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://secure.ws.java.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/ws_secure/calculator?wsdl");
     ...
     * 
     * @return
     *     returns CalculatorIfc
     */
    @WebEndpoint(name = "CalculatorPort")
    public CalculatorIfc getCalculatorPort() {
        return super.getPort(new QName("http://secure.ws.java.com/", "CalculatorPort"), CalculatorIfc.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorPort")
    public CalculatorIfc getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://secure.ws.java.com/", "CalculatorPort"), CalculatorIfc.class, features);
    }
